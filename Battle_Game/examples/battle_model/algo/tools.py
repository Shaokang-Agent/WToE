...
class Runner(object):
    def __init__(self, sess, env, handles, map_size, max_steps, models,
                play_handle, algo, render_every=None, save_every=None, tau=None, log_name=None, log_dir=None, model_dir=None, train=False):
        """Initialize runner
    ...
    def run(self, variant_eps, iteration, win_cnt=None):
        ...
        max_nums, nums, agent_r_records, total_rewards = self.play(env=self.env, algo=self.algo, n_round=iteration, map_size=self.map_size, max_steps=self.max_steps, handles=self.handles,
